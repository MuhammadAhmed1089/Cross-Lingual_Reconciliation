...
from util import anisotropic_cosine_score, get_hf_model_ids, get_langs_list
...
savename = f"../experiments/encoded_datasets/xnli/{model_class}-full_pairwise_cosine.pkl"
